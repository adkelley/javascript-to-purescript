...
believe it's a real advantage over other implementations such as [ports in Elm](https://guide.elm-lang.org/interop/javascript.html).
...
This README is currently under construction. If would like to look at the code samples from Brian's [videos](https://egghead.io/courses/professor-frisby-introduces-composable-functional-javascript) they have been ported to PureScript already. But I may amend them as I write the accompanying tutorial markdown.  
